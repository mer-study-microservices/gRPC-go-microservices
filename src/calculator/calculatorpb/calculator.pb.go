...
func (*SumRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_calculator_94034227c22a2d8a, []int{0}
}
...
func (*SumResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_calculator_94034227c22a2d8a, []int{1}
}
...
func init() {
	proto.RegisterFile("calculator/calculatorpb/calculator.proto", fileDescriptor_calculator_94034227c22a2d8a)
}

var fileDescriptor_calculator_94034227c22a2d8a = []byte{
